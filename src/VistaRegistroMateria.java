...
public class VistaRegistroMateria extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtCreditos.setFont(new java.awt.Font("Candara", 0, 14)); // NOI18N
        txtCreditos.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        jPanel4.add(txtCreditos, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 250, 310, -1));
        ...
        jPanel4.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 230, 73, 26));
...
public void guardarMateria() {
        ...
        // Validar campos
        if (txtMateria.getText().equals("") || creditos.equals("")) {
            JOptionPane.showMessageDialog(null, "Complete todos los campos");

            txtMateria.setBackground(Color.RED);
            txtCreditos.setBackground(Color.RED);
           
       
        } else {
            if (!ControladorMateria.existeMateria(nombre)) {
                // Set user data
                //materia.setNombre(txtMateria.getText().trim());
...
private void Limpiar() {
        ...
        txtCreditos.setBackground(Color.WHITE);
    }
